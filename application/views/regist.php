            ...
            <div class="container">
                <div class="login-content">
                    <div class="login-logo">
                        ...
                        <h3>REGISTER</h3>
                        <p style='font-family: Bradley Hand, cursive; font-weight:bold'>Silahkan Register Akun Anda !</p>
                    </div>
                    <div class="login-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" placeholder="Password Confirm" name="confpassword" id="password_conf" required>
                        </div>
                        <button type="submit" class="btn btn-success btn-flat m-b-30 m-t-30">Sign in</button>
                        <div class="register-link m-t-15 text-center">
                            <p>Have an account ? <a href="<?= base_url(); ?>">Sign In</a></p>
                        </div>
        ...
        $('#registForm').submit(function(e) {
                ...
                // {
                    $.ajax({
                        ...
                        error : function(data) {
                            Swal.fire('Oops,', 'Sign-Up gagal!', 'error');
                           
                                }
                            });   
                    
                // }else{
                //     Swal.fire('Failed', 'User ini sudah terpakai!', 'error');
                // }
