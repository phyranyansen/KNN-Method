                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table id="example2" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php $no=1; foreach($testing as $row) { ?>
                                    <tr>
                                        <td><?= $no++; ?></td>
                                        <td><?= $row['NPM'] ?></td>
                                        <td><?= $row['IPK'] ?></td>
                                        ...
                                        <td style="width: 100px;">
                                            <div class="btn btn-info" id="btedit" data-id2='<?= $row['Id_testing']?>'>
                                                <i class="fa fa-edit"></i>
                                            </div>
                                            <div class="btn btn-danger" id="btdelete1"
                                                data-id1='<?= $row['Id_testing']?>'>
            ...
            <form action="#" id="form-add">
                <div class="modal-body">
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control" id="npm" placeholder="13.0000.00..">
                    </div>
                    <div class="form-group col-md-12">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <select name="status_kerja" class="form-control select2bs4" style="width: 100%;"
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="number" min="0" name="jumlah_mk_diulang" class="form-control" id="jumlah_mk_diulang"
                            placeholder="0">
                    </div>
                    <div class="form-group col-md-12">
                        <label for="excel">Jumlah Organisasi</label>
                        <input type="number" min="0" name="jumlah_organisasi" class="form-control" id="jumlah_organisasi"
                            placeholder="0">
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
    ...
    <div class="modal-dialog modal-default">
        <div class="modal-content">
            ...
            <form action="#" id="form-edit">
                <div class="modal-body">
                    <input type="hidden" name="id_testing" class="form-control" id="get_id_testing" placeholder="13.0000.00..">
                    <div class="form-group col-md-12">
                        <label for="excel">NPM</label>
                    ...
                    <div class="form-group col-md-12">
                        <label for="date">Status Bekerja</label>
                    ...
                    <div class="form-group col-md-12">
                        <label for="excel">Mata Kuliah diulang</label>
                        <input type="number" min="0" name="jumlah_mk_diulang" class="form-control" id="get_jumlah_mk_diulang"
                            placeholder="0">
                    </div>
                    <div class="form-group col-md-12">
                        <label for="excel">Jumlah Organisasi</label>
                        <input type="number" min="0" name="jumlah_organisasi" class="form-control" id="get_jumlah_organisasi"
                            placeholder="0">
                    </div>
...
function update_record() {
    $('#form-edit').submit(function(e) {
        var Updateid_testing = $('#get_id_testing').val();
    ...
    $(document).on('click', '#btdelete1', function() {
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '<?= base_url('delete-dtest');?>',
                    method: 'post',
                    data: {
                        id_testing: Delete_ID
                    },
                    success: function(data) {
                        console.log(data);
                    }
        ...
        if (npm == "" || ipk == "") {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    jumlah_mk_diulang: jumlah_mk_diulang,
                    jumlah_organisasi: jumlah_organisasi
                },
                success: function(data) {
